...
export default function BlogPost() {
  ...
  return (
    <div className="fade-in" style={{ maxWidth: 680, margin: "0 auto" }}>
      <Helmet>
        <title>{post.title} | Squad Audit Blog</title>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", position: 2, name: "Blog", item: "https://squad.csskey.com/blog" },
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {related.map((p) => (
              <Link key={p.slug} to={`/blog/${p.slug}`} style={{ textDecoration: "none" }}>
                <div className="audit-card" style={{ padding: "16px 20px" }}>
                  <div style={{ fontSize: 10, color: "var(--text-faint)", letterSpacing: "0.1em", marginBottom: 4, fontFamily: "var(--font-mono)" }}>{p.date}</div>
