...
export default function MetricDetailPage() {
  ...
  if (!metric) return <Navigate to="/metrics" replace />;
  ...
  return (
    <div className="fade-in" style={{ maxWidth: 680, margin: "0 auto" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        <div className="eyebrow" style={{ marginBottom: 8 }}>Metric {String(index + 1).padStart(2, "0")} of 05</div>
      ...
      <div className="audit-card" style={{ padding: "28px 32px", marginBottom: 24 }}>
        <div className="eyebrow" style={{ marginBottom: 12 }}>Metric Analysis</div>
      ...
      <div className="audit-card" style={{ padding: "24px 32px", marginBottom: 24 }}>
        <div className="eyebrow" style={{ marginBottom: 12 }}>Score Range</div>
      ...
      {/* How to improve */}
      <div className="audit-card" style={{ padding: "28px 32px", marginBottom: 24 }}>
        <div className="eyebrow" style={{ marginBottom: 12, color: metric.color }}>How to Improve</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }} className="metric-signs-grid">
        <div className="audit-card" style={{ padding: "24px 28px" }}>
          <div className="eyebrow" style={{ marginBottom: 10, color: "var(--success)" }}>Signs of Health</div>
        ...
        <div className="audit-card" style={{ padding: "24px 28px" }}>
          <div className="eyebrow" style={{ marginBottom: 10, color: "var(--danger)" }}>Signs of Problems</div>
      ...
      {related.length > 0 && (
        <section style={{ marginBottom: 32 }}>
          <div className="eyebrow" style={{ marginBottom: 12 }}>Other Squad Metrics</div>
