...
add('/', 1.0); add('/roles', 0.9); add('/metrics', 0.8); add('/blog', 0.8)
...
console.log(`Sitemap: ${6 + roleSlugs.length + blogSlugs.length} URLs (${roleSlugs.length} roles, ${blogSlugs.length} blog)`)
